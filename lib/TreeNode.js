...
TreeNode.propTypes = {
  ...
  switcherOpenIcon: _propTypes2['default'].oneOfType([_propTypes2['default'].node, _propTypes2['default'].func]),
  checkboxIcon: _propTypes2['default'].oneOfType([_propTypes2['default'].node, _propTypes2['default'].func]),
  checkboxCheckedIcon: _propTypes2['default'].oneOfType([_propTypes2['default'].node, _propTypes2['default'].func]),
  additionalContent: _propTypes2['default'].oneOfType([_propTypes2['default'].node, _propTypes2['default'].func])
};
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderSwitcher = function () {
    ...
    $switcher = typeof switcherIcon !== 'undefined' && typeof switcherOpenIcon !== 'undefined' ? _this2.renderCustomSwitcher() : _react2['default'].createElement('span', {
  ...
  this.renderCheckbox = function () {
    ...
    $checkbox = typeof checkboxIcon !== 'undefined' && typeof checkboxCheckedIcon !== 'undefined' ? _this2.renderCustomCheckbox() : _react2['default'].createElement(
      'span',
      {
